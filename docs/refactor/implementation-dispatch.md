...
Steps 1.2 through 3.15 and Phase 4.1 are complete at this tip. Phase 4.2's Project Registry is next. Continue through [`remaining-implementation.md`](remaining-implementation.md) serially, using the pipelined landing workflow above. The product is still manifest-driven.
...
3.1 through 3.15 and 4.1 are complete at this tip. Phase 4.2 begins next. Keep the Tailwind generation running throughout. The compatibility ceilings are the Extensions API for the host and Chromium 148 for the webview.
