...
| S1    | 5.5               | `docs/adr/0005-dependency-diagnostics.md`. Inconclusive: the project did not finish loading within 60s (`models_count` 0, estimate true) and no `publishDiagnostics` arrived. **D3** stays provisional. Gate not discharged.                                                                                                                                                                                                                                          |
