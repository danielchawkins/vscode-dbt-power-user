...
**Completed at this tip:** 1.2 version gate, 1.3 conflict guard and `enabled`, all of Phase 2, steps 3.1 through 3.15, Phase 4.1's folder-scoped Declared Project resolver, and Phase 4.2's Project Registry. The extension packages as `0.1.0-alpha.0` against the 1.128 Extensions API with webview compiled for Chromium 148.
...
**Next:** Phase 4.3 introduces Project Context.
