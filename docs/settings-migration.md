...
| `dbt.lineage.showSelectEdges`                | `fusionPowerUser.lineage.showSelectEdges`                | window   |                                                                       |
| `dbt.lineage.showNonSelectEdges`             | `fusionPowerUser.lineage.showNonSelectEdges`             | window   |                                                                       |
...
| `dbt.queryScale`                             | `fusionPowerUser.query.scale`                            | window   |                                                                       |
